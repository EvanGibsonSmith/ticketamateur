        ...
        <body>
            ...
            <div className="flex row align-flex-start">
                <div className="flex align-center column width50 height50 align-flex-start">
                    ...
                    <button id='searchshow' onClick={e => searchShow()}>Search Show</button>
                </div>
                ...
                <div className="flex column align-left scroll margin-children" style={{width: "500px", height: "600px", backgroundColor: "gainsboro"}}>
